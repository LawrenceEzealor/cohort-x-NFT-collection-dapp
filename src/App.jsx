...
//         <main className="mt-6">
//           <AppTabs
//             MyNfts={<MyNFT myTokensData={myTokensData} isLoading={isLoading} />}
//             AllCollections={<Collections tokensData={tokensData} />}
//           />
//         </main>
//         <ToastContainer />
//       </Container>
...
function App() {
  ...
  // Add a check to ensure myTokenIds is defined and is an array
  const myTokensData =
    myTokenIds && Array.isArray(myTokenIds)
      ? tokensData.filter((x, index) => myTokenIds.includes(index))
      : [];
